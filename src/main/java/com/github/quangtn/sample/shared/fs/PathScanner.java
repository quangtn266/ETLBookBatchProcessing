...
public class PathScanner {
    ...
    public PathScanner(@Nonnull Predicate<Path> fileFilter) {this.fileFilter = fileFilter; }
    ...
    private void scan(FileStatus fileStatus, FileSystem fs, List<Path> result) throws IOException {
